...
#So we get ~56.96 for a pruned tree
...
#We tried increasing the number of trees but for efficiency use 100

bag.reg2 = randomForest(registered~., reg_train, mtry = 11, ntree = 300, importance = TRUE)
bag.reg2
...
bag.cas2 = randomForest(casual~., cas_train, mtry = 11, ntree = 500, importance = TRUE)
bag.cas2
